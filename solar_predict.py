...
# Load the dataset
dataset1 = pd.read_csv('./small_data/data1_cleaned.csv')
dataset2 = pd.read_csv('./small_data/data2_cleaned.csv')
dataset3 = pd.read_csv('./small_data/data3_cleaned.csv')
dataset4 = pd.read_csv('./small_data/data4_cleaned.csv')
dataset5 = pd.read_csv('./small_data/data5_cleaned.csv')
...
history = model.fit(train_data, train_labels, epochs=100, validation_data=(dev_data, dev_labels), callbacks=[early_stop, reduce_lr])
